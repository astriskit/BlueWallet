...
const icons = {
  ...
  ViewInEth: { iconValue: 'bitcoinsign.circle' },
  ViewInGwei: { iconValue: 'bitcoinsign.circle' },
...
export const CommonToolTipActions: Record<string, ToolTipAction> = {
  ...
  ViewInEth: {
    id: keys.ViewInEth,
    text: 'Display in Ethereum',
    icon: icons.ViewInEth,
    hidden: false,
  },
  ViewInGwei: {
    id: keys.ViewInGwei,
    text: 'Display in Gwei',
    icon: icons.ViewInGwei,
    hidden: false,
  },
  Entropy: {
    id: keys.Entropy,
